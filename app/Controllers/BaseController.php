...
abstract class BaseController extends Controller
{
    ...
    public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger)
    {
        ...
        $this->pageData['vtype'] = 1; 
        $vTypeValue = get_cookie($index='vtype', $xssClean = false, $prefix = '');
        if(isset($vTypeValue) && !empty($vTypeValue)){
            $this->pageData['vtype'] = $vTypeValue;
            $this->vtype = $vTypeValue==1?1:2;
        }
