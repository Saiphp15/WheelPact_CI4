...
<head>
	...
	<!-- sweet alert Link -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/admin/src/plugins/sweetalert2/sweetalert2.css">
...
<body>
			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="<?php echo base_url('admin/add-branch'); ?>">Add Showroom</a></li>
							<li><a href="<?php echo base_url('admin/view-showrooms'); ?>">View Showrooms</a></li>
						</ul>
					</li>
					<li class="dropdown">
	...
	<!-- sweet alert  -->
	<script src="<?php echo base_url(); ?>assets/admin/src/plugins/sweetalert2/sweetalert2.all.js"></script>
	<script src="<?php echo base_url(); ?>assets/admin/src/plugins/sweetalert2/sweet-alert.init.js"></script>
	<!-- fancy box for gallery -->
