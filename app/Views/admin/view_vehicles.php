    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="row">
                    <div class="col-12">
                        <table class="table table-bordered" id="vehicleList">
                            <thead>
                                <tr>
                                    <th>Sr.No</th>
                                    <th class="datatable-nosort">Thumbnail</th>
                                    <th>Showroom</th>
                                    <th>Type</th>
                                    <th>Brand</th>
                                    <th>Model</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('admin/single-vehicle-info/'.$item['encrypted_id']); ?>" class="btn btn-info btn-xs" title="View Vehicle Info"><i class="ion-eye"></i></a>
                                        <a href="<?php echo base_url('admin/edit-vehicle/'.$item['encrypted_id']); ?>" class="btn btn-primary btn-xs" title="Edit Vehicle Info"><i class="ion-edit"></i></a>
                                        <a href="javascript:void(0);" id="" data-id="<?php echo $item['id']; ?>" data-actionurl="<?php echo base_url('admin/remove-vehicle'); ?>" data-operation="delete" class="btn btn-danger btn-xs actionBtn" title="Remove Vehicle Info"><i class="ion-trash-a"></i></a>
                                    </td>
                                </tr>
                                <?php $i++; endforeach; ?>
                            </tbody>
