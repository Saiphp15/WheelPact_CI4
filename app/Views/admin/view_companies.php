                                    ...
                                    <tr class="tr_<?php echo $item['id']; ?>">
                                        ...
                                        <td>
                                            <?php if ($item['is_active'] == '1') { ?>
                                                <a href="javascript:void(0);" data-toggle="tooltip" title="Deactivate this Company in listing" data-id="<?php echo $item['id']; ?>" data-actionurl="<?php echo base_url('admin/change-company-status/disable'); ?>" data-operation="deactivate" class="btn btn-success btn-xs actionBtn">Enabled</a>
                                            <?php } else { ?>
                                                <a href="javascript:void(0);" data-toggle="tooltip" title="Activate this Company in listing" data-id="<?php echo $item['id']; ?>" data-actionurl="<?php echo base_url('admin/change-company-status/enable'); ?>" data-operation="activate" class="btn btn-warning btn-xs actionBtn">Disabled</a>
                                            <?php } ?>
                                        </td>
                                        <td>
