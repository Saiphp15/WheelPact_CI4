                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel"
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item v-image-item active">
                                    <img src="<?php echo isset($vehicleDetails['thumbnail_url']) && !empty($vehicleDetails['thumbnail_url'])?$vehicleDetails['thumbnail_url']:base_url('public/assets/admin/src/images/default-img.png'); ?>" alt="Thumbnail Image">
