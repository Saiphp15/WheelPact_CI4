                    ...
                    <div class="col-md-6 col-lg-4">
                        <a href="<?php echo base_url('store-details/'.$store['encrypted_id']); ?>">
                            <div class="store-wrapper">
                                <img src="<?php echo isset($store['branch_thumbnail']) && !empty($store['branch_thumbnail'])?base_url('uploads/branch_thumbnails/'.$store['branch_thumbnail']):base_url('public/assets/admin/src/images/default-img.png'); ?>">
