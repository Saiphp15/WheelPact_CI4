...
$routes->get('admin/view-showrooms', 'AdminController::view_showrooms');

$routes->get('admin/single-branch-info/(:any)', 'AdminController::single_branch_info/$1');
$routes->get('admin/edit-branch-details/(:any)', 'AdminController::edit_branch_details/$1');
$routes->post('admin/edit-update-branch-details', 'AdminController::edit_update_branch_details');
$routes->post('admin/change-branch-status/(:any)', 'AdminController::change_branch_status/$1');
/* Santosh Routing End */
