$(document).ready(function () {
      ...
      $.ajax({
        ...
        success: function (response) {
          if (response.success) {
            ...
            $("#vehicleBasicInformationMultipartFormWrapper").html(
      ...
      $.ajax({
        ...
        success: function (response) {
          if (response.status === "success") {
            ...
            $("#thumbnailPreviewContainer").html(
              '<img src="' + response.thumbnail_url + '" alt="Thumbnail" />'
            );
          } else {
  ...
  $("#upload_exterior_main_vehicle_images_form").submit(function (event) {
    ...
    if (vehicleId === "") {
      ...
      if (
        !validateVehicleImagesFields("upload_exterior_main_vehicle_images_form")
      ) {
        return false;
      } else {
        var formData = new FormData(this);
        var action_page = $("#upload_exterior_main_vehicle_images_form").attr(
          "action"
        );
        $.ajax({
          url: action_page,
  ...
  $("#upload_interior_vehicle_images_form").submit(function (event) {
    ...
    if (vehicleId === "") {
      ...
      if (!validateVehicleImagesFields("upload_interior_vehicle_images_form")) {
        ...
        var formData = new FormData(this);
        var action_page = $("#upload_interior_vehicle_images_form").attr(
          "action"
        );
        $.ajax({
          url: action_page,
  ...
  $("#upload_others_vehicle_images_form").submit(function (event) {
    ...
    if (vehicleId === "") {
      ...
      if (!validateVehicleImagesFields("upload_others_vehicle_images_form")) {
        ...
        var formData = new FormData(this);
        var action_page = $("#upload_others_vehicle_images_form").attr(
          "action"
        );
        $.ajax({
          url: action_page,
          ...
          $.ajax({
            ...
            success: function (resp) {
              ...
              if (resp_statuscode == 200) {
                ...
                swal(
                  { title: "Removed", text: resp_msg, type: "success" },
                  function () {
                    window.location.reload();
                  }
                );
  ...
  $("#edit_update_branch_details").submit(function (event) {
    ...
    if (!validateStep(currentStep)) {
      ...
      var formData = new FormData(this);
      var action_page = $("#edit_update_branch_details").attr("action");
      $.ajax({
        url: action_page,
        type: "POST",
        data: formData,
