$(document).ready(function () {
    ...
    $("#save_branch_form").on("submit", function (event) {
        ...
        if (selectDealer === '') {
            ...
            document.getElementById('selectDealer').focus()
            e.preventDefault()
            return
        }
        ...
        if (branchType === '') {
            swalValidate(
                ...
                'error',
                'bottom-right',
                'Please choose the branch type.!',
                5000,
                true
            )
            document.getElementById('branchType').focus()
            e.preventDefault()
            return
        }
        ...
        if (branchSupportedVehicleType === '') {
            swalValidate(
                ...
                'error',
                'bottom-right',
                'Please choose the branch Supported Vehicle type.',
                5000,
                true
            )
            document.getElementById('branchSupportedVehicleType').focus()
            e.preventDefault()
            return
        }
        ...
        if (branchThumbnail === '') {
            swalValidate(
                ...
                'error',
                'bottom-right',
                'Please choose the branch thumbnail.',
                5000,
                true
            )
            document.getElementById('branchThumbnail').focus()
            e.preventDefault()
            return
        }
        ...
        if (branchBanner1 === '') {
            swalValidate(
                ...
                'error',
                'bottom-right',
                'Please choose the branch Banner1.',
                5000,
                true
            )
            document.getElementById('branchBanner1').focus()
            e.preventDefault()
            return
        }
        ...
        if (branchBanner2 === '') {
            swalValidate(
                ...
                'error',
                'bottom-right',
                'Please choose the branch Banner2.',
                5000,
                true
            )
            document.getElementById('branchBanner2').focus()
            e.preventDefault()
            return
        }
        ...
        if (branchBanner3 === '') {
            swalValidate(
                ...
                'error',
                'bottom-right',
                'Please choose the branch Banner3.',
                5000,
                true
            )
            document.getElementById('branchBanner3').focus()
            e.preventDefault()
            return
        }
        ...
        if (chooseState === '') {
            ...
            document.getElementById('chooseState').focus()
            e.preventDefault()
            return
        }
...
function swalValidate(toast, animation, type, position, title, timer, timerProgressBar) {
    /* swalValidate(true, true, 'error', 'bottom-right', 'Please choose dealer!', 5000, true);*/
    swal({
        toast: toast,
        animation: animation,
        type: type,
